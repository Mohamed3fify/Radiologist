package com.example.drchat.ui.theme
...
val Grey = Color(0xFF141919)
val warmGrey = Color(0x6DECECEC)
val darkBlue = Color(0xFF191970)
val botResponse = Color(0xFF282C2D)
